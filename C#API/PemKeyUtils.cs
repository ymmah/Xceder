...
{
    /// <summary>
    /// extract the key parameters from the pem key file
    /// </summary>
    public class PemKeyUtils
    {
        ...
        /// <summary>
        /// extract the key parameters from the file
        /// </summary>
        /// <param name="pemfile"></param>
        /// <returns>return null if fail</returns>
        public static RSAParameters? GetRSAProviderFromPemFile(string pemfile)
        {
        ...
        /// <returns></returns>
        public static byte[] DecodeOpenSSLPublicKey(string keyVal)
        {
            const string pempubheader = "-----BEGIN PUBLIC KEY-----";
            const string pempubfooter = "-----END PUBLIC KEY-----";
            string pemstr = keyVal.Trim();
            byte[] binkey;
            if (!pemstr.StartsWith(pempubheader) || !pemstr.EndsWith(pempubfooter))
                return null;
        ...
        /// <returns></returns>
        public static RSAParameters? DecodeX509PublicKey(byte[] x509key)
        {
